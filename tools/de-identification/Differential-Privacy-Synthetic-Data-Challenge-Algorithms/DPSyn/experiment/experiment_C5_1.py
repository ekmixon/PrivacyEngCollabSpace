...
class Experiment_C5_1(Experiment_C5):
    ...
    def configuration_C5_1(self):
        ...
        self.calculate_noise_parameter(187)
        ...
        # city_threshold = 240 / self.epsilon
        ...
        attributes_list = ["INCWAGE", "LF_INCNON", "EMPSTATD", "CLASSWKRD", "OCC1950",
                           "IND1950", "WKSWORK2", "HRSWORK2", "AGE", "EDUCD"]
        ...
        ##### generate geo-spatial related marginals (20) #####
        # we have reserved privacy budget for ENUMDIST related marginals,
        # thus do not count as the number of marginals to calculate sigma in function calculate_noise_parameter()
        self.generate_enumdist_marginal()
        
        attributes_list = ["METAREAD", "UR_FA_MT", "CITY", "COUNTY", "ENUMDIST"]
        for attributes_group_key in combinations(attributes_list, 2):
            self.generate_marginal(attributes_group_key, views_group_name="AGE2")
        ...
        self.generate_marginal(["CITYPOP", "URBPOP"], views_group_name="AGE2", is_iterate=False, is_consist=False)
        ...
        ########################################## Group SL #############################################
        # Totally marginals 12 marginals
